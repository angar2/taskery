...
| 2026-08-09 | 출제 분리 정합 — TASK_DOC_RULE §1.5 test-plan-origin 행(B 원문 보존·규약상 불변) + §2.5 출제 분리 계약(방식 칸 불가침 / 플래그 문법 / 무플래그=오염 반려)·기대값 출처 표기 신설을 반영. recordion FRICTION 2026-08-09 |
